...
from timespace.box_utils import get_boxes_from_ego_poses, get_bbox_points

def construct_transform_matrix(rotation_matrix, translation):
    trans_mat = np.eye(4)

    trans_mat[:3,:3] = rotation_matrix
    trans_mat[:3,-1] = translation
