...
if __name__ == "__main__":
    file = glob.glob('/home/patrik/patrik_data/livox/22-03-07_08-47-00_HondaJazz_F6021_ES_D_RN_HW_RIGHT_OV_0025/*.lvx')[0]

    # stream_names = LvxReader().get_stream_names(file, print_info=True)
    convert_data(file, time=[-np.inf, np.inf], out_dir='/home/patrik/patrik_data/livox/22-03-07_08-47-00_HondaJazz_F6021_ES_D_RN_HW_RIGHT_OV_0025/lidar', apply_ego_trans=False)
